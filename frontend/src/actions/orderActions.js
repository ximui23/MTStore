...
import {
    ...
    ORDER_MINE_LIST_FAIL, ORDER_MINE_LIST_SUCCESS, ORDER_MINE_LIST_REQUEST,
...
export const listOrderMine = () => async (dispatch, getState) => {
    ...
    try {
        ...
        //after getting data, dispatch success action
...
//display list of orders to admin user
...
//This action is used for admin user to delete order
