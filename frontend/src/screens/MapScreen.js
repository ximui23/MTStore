...
const libs = ['places'];
const defaultLocation = { lat: 34.052235, lng: -118.243683 };
...
export default function MapScreen(props) {
    ...
    const onConfirm = () => {
        ...
        //if places exist and its length = 1
        if (places && places.length === 1) {
            ...
            //after location is selected successfully, redirect user to Shipping Page
