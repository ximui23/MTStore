...
export const LIST_TOP_PRODUCTS_REQUEST = 'LIST_TOP_PRODUCTS_REQUEST';
export const LIST_TOP_PRODUCTS_SUCCESS = 'LIST_TOP_PRODUCTS_SUCCESS';
export const LIST_TOP_PRODUCTS_FAIL = 'LIST_TOP_PRODUCTS_FAIL';
